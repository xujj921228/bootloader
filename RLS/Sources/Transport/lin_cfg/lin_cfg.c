...
l_u8    lin_pFrameBuf[LIN_FRAME_BUF_SIZE] =
{
  ...
  ,0x00 /* 3 : 00000000 */ /* start of frame LI0_RLS_01 */
...
const lin_frame_struct lin_frame_tbl[LIN_NUM_OF_FRMS] ={
   ...
   ,{ LIN_FRM_UNCD, 5, LIN_RES_PUB, 3, 1, 2 , (l_u8*)&LI0_response_error_signal }
...
l_u8 lin_configured_NAD = 0x6A;    /*<configured_NAD>*/
const l_u8 lin_initial_NAD    =0x6A;    /*<initial_NAD>*/
