        ...
        case SERVICE_READ_DATA_BY_IDENTIFY:
			...
			{				
				...
				if (error_code == (LIN_PRODUCT_SERIAL_NUMBER0&0xFF))
				{
					...
					lin_tl_pdu[5] = (l_u8)(Hardware_Versions[0]);
					lin_tl_pdu[6] = (l_u8)(Hardware_Versions[1]);
					lin_tl_pdu[7] = (l_u8)(Hardware_Versions[2]);					
				...
				else if (error_code == (LIN_PRODUCT_SERIAL_NUMBER2&0xFF))
				{
					...
					lin_tl_pdu[5] = (l_u8)(Software_Versions[0]);
					lin_tl_pdu[6] = (l_u8)(Software_Versions[1]);
					lin_tl_pdu[7] = (l_u8)(Software_Versions[2]);					
				...
				else if (error_code == (LIN_LS_FW_PARAM&0xFF))
				{
					...
					lin_tl_pdu[5] = (l_u8)(local_info.Brightness_Light_Percentage);
				}
				else if (error_code == (LIN_LS_IR_PARAM&0xFF))
				{
					...
					lin_tl_pdu[5] = (l_u8)(local_info.Brightness_Infrared_Percentage);
				}
        ...
        if (sid_supported_flag == 1)
        {
            switch (sid)
            {
                ...
                case SERVICE_SAVE_CONFIGURATION:
                    ...
                    break;
                case SERVICE_ASSIGN_NAD:
                    lin_tl_make_slaveres_pdu(iii, SERVICE_ASSIGN_NAD, POSITIVE, 0U);
                    break;
                case SERVICE_CONDITIONAL_CHANGE_NAD:
