...
extern uint8  u8_Wip_low;
extern uint8  u8_Wip_High;
extern uint8  u8_rain_state_polling_flg;

extern uint8  u8_Err_Flg;
extern uint8  u8_Rain_Flg;
extern uint8  u8_Window_Flg;
extern uint8  u8_Window_CTL;

extern uint8  u8_G_FW_Config;
extern uint8  u8_G_IR_Config;

extern uint8 u8_ExitLowSpeedTimer;
extern uint8 u8_EnterLowSpeedCnt;
extern uint8  u8_cnt_choose;
extern uint8  u8_cnt_choose_pre;
extern uint8  u8_Int_Time;
extern uint8  u8_Int_Time_pre;
...
extern uint8 u8_MeasureSureTime;
...
extern uint16 u16_window_cnt;

extern uint16 u16_IR_left_AD;
extern uint16 u16_IR_right_AD;
...
extern uint8 RLS_Wiper_Ctl(uint8 Int_Timer, uint8 Wiper_Timer);
extern void RLS_Get_IR_Process(void);
