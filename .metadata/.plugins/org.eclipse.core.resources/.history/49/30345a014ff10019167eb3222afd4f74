...
./Sources/LIN_Stack/transport/lin_j2602tl_api.d \
...
Sources/LIN_Stack/transport/lin_j2602tl_api.o: ../Sources/LIN_Stack/transport/lin_j2602tl_api.c
	@echo 'Building file: $<'
	@echo 'Executing target #19 $<'
	@echo 'Invoking: ARM Ltd Windows GCC C Compiler'
	"$(ARMSourceryDirEnv)/arm-none-eabi-gcc" "$<" @"Sources/LIN_Stack/transport/lin_j2602tl_api.args" -MMD -MP -MF"$(@:%.o=%.d)" -o"Sources/LIN_Stack/transport/lin_j2602tl_api.o"
	@echo 'Finished building: $<'
	@echo ' '
